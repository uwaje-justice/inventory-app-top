...
export default function CategoryDetailPage() {
  ...
  const { data: category, loading, error, refetch } = useFetch(() => getCategory(id), [id]);
  ...
  if (error || !category) return <ErrorAlert message={error || "Category not found."} onRetry={refetch} />;
  ...
  return (
    <div className="space-y-6">
      <ConfirmDialog
        ...
        message="This will permanently delete this category and all its items. This action cannot be undone."
