...
export default function Footer() {
  return (
    <footer className="border-t border-outline-variant bg-surface-container-low py-8">
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-4 px-5 md:flex-row md:justify-between md:px-8">
        <p className="text-sm text-on-surface-variant">
          Built by <span className="font-semibold text-on-surface">Uwaje Justice</span>
        </p>
